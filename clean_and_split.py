...
def main(input_path: str = INPUT_PATH, output_dir: str = OUTPUT_DIR, encoding: str = DEFAULT_ENCODING, cohort_year: Optional[int] = None, strict: bool = False):
    ...
    for idx, d in enumerate(rows):
        ...
        t1_rows.append({
            ...
            "WhatsApp": wa or "",
            "Alternative": alt or "",
            "Parent/Guardian Name": p_name or "N/A",
            "Parent/Guardian Contact": p_contact or "N/A",
            "Ras": ras_val,
            "Skoolprestasies": skool_val,
            "SASSA kindertoelaag": sassa_val,
            "Applicant Details": app_text,
            **(lambda _vals: {
                "SASSA pensioen": _vals[0] or "N/A",
                "Inkomste": _vals[1] or "N/A",
                "Beroep van Ma": _vals[2] or "N/A",
                "Beroep van Pa": _vals[3] or "N/A",
                "Ma kwalifikasie": _vals[4] or "N/A",
                "Pa kwalifikasie": _vals[5] or "N/A",
            })(parse_family_details_fields(d.get(family_details_col, "") if family_details_col else "")),
